...
All assay definitions, peak parameters, clonality rules, ladder settings,
channel colours, reference ranges, and display labels extracted from the
original ``fraggler_master_assay_channels.py``.
"""
